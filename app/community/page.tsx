  ...
  return (
    <main className="community-page">
      <style>{`
        ...
        .community-nav{display:flex;gap:22px;color:#6d6963;font:11px Inter,system-ui,sans-serif}
        .community-nav a:hover{color:#5d554d}
        .community-main{padding:70px 0 90px}
        .community-main .eyebrow{margin:0 0 14px;color:#81786f;font:800 9px/1 Inter,system-ui,sans-serif;letter-spacing:.19em}
        ...
        .community-meta{margin-top:18px;color:#81786f;font:10px Inter,system-ui,sans-serif;letter-spacing:.06em;text-transform:uppercase}
        ...
        .community-card footer{margin-top:auto;padding-top:20px;color:#514b45;font:700 11px Inter,system-ui,sans-serif}
        .community-card .category{margin-top:5px;color:#81786f;font:800 8px Inter,system-ui,sans-serif;letter-spacing:.12em;text-transform:uppercase}
        .community-card .source{margin-top:9px;color:#8d8881;font:10px/1.4 Inter,system-ui,sans-serif}
        ...
        .community-footer{padding:20px 0 28px;border-top:1px solid #d4d0ca;color:#817b74;display:flex;justify-content:space-between;font:9px Inter,system-ui,sans-serif;letter-spacing:.05em}
        ...
        @media(max-width:560px){.community-header,.community-main,.community-footer{width:calc(100% - 32px)}.community-main{padding:44px 0 60px}.community-main h1{font-size:50px}.community-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:34px}.community-card{min-height:175px;padding:14px 12px}.community-card blockquote{font-size:14px;line-height:1.28}.community-card footer{padding-top:12px;font-size:8px}.community-card .category{font-size:7px}.community-card .source{font-size:8px}.community-cta{margin-top:44px;padding-top:26px}.community-cta h2{font-size:26px}.community-footer{flex-direction:column;gap:8px}}
      `}</style>
