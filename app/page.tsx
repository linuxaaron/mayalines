...
export default function Home() {
  ...
  return <main className="site-shell redesign-shell" id="main-content" tabIndex={-1}>
    ...
    <header className="header"><TotalLikes /><a className="brand" href="#top" aria-label="Mayalines home"><Image className="brand-mark" src="/sunflower-logo.png" alt="" aria-hidden="true" width={46} height={46} priority /><span className="brand-copy"><span className="brand-name">MAYALINES</span><span className="brand-tagline">WORDS THAT LAST.</span></span></a><div className="header-rule" aria-hidden="true" /><SiteRating /><nav className="nav" aria-label="Main navigation"><MegaMenu /></nav></header>
