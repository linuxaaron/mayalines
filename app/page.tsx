  ...
  return <main className="site-shell redesign-shell">
    <style>{`
      ...
      @media(max-width:560px){
        .redesign-shell .hero{padding-top:104px}
        .nietzsche-float-inner{top:12px;width:calc(100vw - 32px)}
        .nietzsche-quote{font-size:14px;line-height:1.42}
        .nietzsche-word{margin-right:.23em}
        .redesign-shell .quote-of-the-day{margin-left:16px;margin-right:16px;padding:30px 22px}
        .redesign-shell .seo-intro{margin-left:16px;margin-right:16px}
        .redesign-shell .footer-inner{margin:0 16px}
        .redesign-shell .footer-bottom{margin:0 16px}
        .redesign-shell .quote-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:12px}
        .redesign-shell .quote-card{min-height:170px;padding:13px 12px 10px;border-radius:5px}
        .redesign-shell .quote-card:before{width:2px}
        .redesign-shell .quote-mark{font-size:23px}
        .redesign-shell .quote-text{margin-top:9px;font-size:14px;line-height:1.25;letter-spacing:-.015em}
        .redesign-shell .quote-author{margin-top:7px;font-size:9px;line-height:1.2}
        .redesign-shell .quote-category{margin-top:4px;font-size:7px;line-height:1.15;letter-spacing:.08em}
        .redesign-shell .quote-actions{gap:5px;padding-top:7px}
        .redesign-shell .like-button{width:28px;height:28px}
        .redesign-shell .heart-icon{font-size:12px}
        .redesign-shell .like-count{font-size:8px}
        .redesign-shell .copy-button{padding:5px 6px;font-size:7px;letter-spacing:.05em}
        .redesign-shell .category-rail{gap:7px 12px;padding:12px 0}
        .redesign-shell .category-rail button,.redesign-shell .category-rail a{font-size:8px}
      }
    ...
    <footer className="footer" id="about"><div className="footer-inner"><div><div className="footer-brand">MAYALINES</div><p className="footer-note">Timeless words, carefully collected. Discover quotes, authors, poems and ideas worth keeping.</p></div><nav className="footer-links" aria-label="Legal and accessibility navigation"><a href="/submit">Submit a quote</a><a href="/community">Community quotes</a><a href="/poems">Poems</a><a href="/imprint">Imprint</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/copyright">Copyright</a><a href="/accessibility">Accessibility</a></nav></div><div className="footer-bottom">© 2026 Mayalines · Words that last.</div></footer>
  </main>;
}
