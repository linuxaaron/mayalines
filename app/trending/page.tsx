...
export default async function TrendingPage() {
  ...
  return <main className="site-shell"><header className="header"><a className="brand" href="/"><span className="brand-name">MAYALINES</span></a><div className="header-rule"/><nav className="nav"><a href="/">Quotes</a><a href="/popular">Popular</a><a href="/trending" aria-current="page">Trending</a><a href="/topics">Topics</a><a href="/authors">Authors</a></nav></header><section className="hero"><p className="eyebrow">MAYALINES · LIVE DISCOVERY</p><h1>Trending Quotes</h1><p className="hero-copy">See quotes receiving attention from readers. When recent activity is still sparse, MAYALINES keeps this page useful with a fresh daily selection from the verified quote library.</p></section><section className="library"><div className="section-heading">Trending now</div><p className="library-meta">{hasRecentLikes ? "Most liked during the last seven days" : "Fresh daily selection while recent community activity grows"}</p><QuoteResults quotes={quotes}/></section><footer className="footer">© 2026 Mayalines</footer></main>;
}
