  ...
  return (
    <main className="page">
      ...
      <div className="wrap">
        ...
        <section className="related"><h2>Explore more</h2><Link href="/collections/quotes-about-life">Life Quotes</Link><Link href="/collections/quotes-about-motivation">Motivation Quotes</Link><Link href="/collections/quotes-about-wisdom">Wisdom Quotes</Link></section>
      </div>
    </main>
  );
}
