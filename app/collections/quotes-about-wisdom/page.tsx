...
export default function WisdomQuotesPage() {
  return (
    <main className="page">
      ...
      <div className="wrap">
        <header className="head"><Link href="/">← MAYALINES</Link><p className="eyebrow">CURATED COLLECTION</p><h1>Wisdom Quotes</h1><p className="intro">Timeless words about knowledge, perspective, truth and the art of living well.</p></header>
