...
function isSeoCleared(quote: (typeof quotesData)[number]) {
...
export default async function CollectionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const quotes = quotesData.filter((quote) => {
    if (!isSeoCleared(quote)) return false;
  ...
  return <main className="collection-page">
    <style>{`
      ...
      .collection-hero{padding:70px 0 42px}
      ...
      .collection-hero p:not(.eyebrow){max-width:720px;margin:22px 0 0;color:#48433d;font:15px/1.65 Inter,system-ui,sans-serif}
      .collection-meta{margin-top:18px!important;color:#765843!important;font:750 10px Inter,system-ui,sans-serif!important;letter-spacing:.08em;text-transform:uppercase}
      .collection-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;padding:12px 0 70px}
      .collection-quote{min-height:300px;max-width:100%;padding:24px 22px 18px;border:1px solid #bdb8af;border-radius:6px;background:#e7e4de;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 6px 18px rgba(23,21,19,.03)}
      .quote-mark{color:#765843;font:36px Georgia,serif;line-height:.7}
      .quote-text{margin:18px 0 0;color:#11100f;font:20px/1.34 Georgia,serif;letter-spacing:-.01em;overflow-wrap:break-word}
      .quote-author{margin:14px 0 0;color:#514b45;font:700 11px Inter,system-ui,sans-serif;overflow-wrap:break-word}
      .quote-actions{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-top:auto;padding-top:18px}
      .like-control{display:flex;align-items:center;gap:6px}.like-button{width:34px;height:34px;display:inline-grid;place-items:center;border:1px solid #bdb8af;border-radius:50%;color:#766f67}.like-button.is-liked{color:#c62828;background:rgba(198,40,40,.08);border-color:rgba(198,40,40,.55)}.heart-icon{font-size:14px}.like-count{font:10px Inter,system-ui,sans-serif;color:#5f5a53}
      .copy-button{padding:7px 10px;border:1px solid #bdb8af;border-radius:4px;color:#765843;background:transparent;font:750 9px Inter,system-ui,sans-serif;letter-spacing:.08em}.copy-button:hover{background:#765843;color:#fff}
      .collection-author{margin-top:18px;display:inline-block;max-width:100%;color:#765843;font:750 10px/1.4 Inter,system-ui,sans-serif;letter-spacing:.08em;text-transform:uppercase;overflow-wrap:anywhere}
      .related{padding:34px 0 62px;border-top:1px solid #bdb8af}.related-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.related-link{display:block;padding:16px;border:1px solid #bdb8af;border-radius:5px;background:#e7e4de;color:#514b45;font:600 11px/1.4 Inter,system-ui,sans-serif;overflow-wrap:break-word}
      ...
      @media(max-width:560px){
        .collection-page{overflow-x:hidden}
        .collection-wrap{width:calc(100% - 28px);margin:0 14px}
        .collection-header{padding:20px 0;align-items:flex-start;gap:15px;flex-direction:column}
        .collection-brand{font-size:21px}
        .collection-nav{width:100%;justify-content:flex-start;gap:10px 18px;font-size:11px}
        .collection-hero{padding:42px 0 30px}
        .collection-hero h1{font-size:clamp(38px,12vw,54px);line-height:1;letter-spacing:-.04em}
        .collection-hero p:not(.eyebrow){margin-top:18px;font-size:14px;line-height:1.6}
        .collection-grid{grid-template-columns:minmax(0,1fr);gap:10px;padding:8px 0 48px}
        .collection-quote{width:100%;min-height:220px;padding:20px 18px 16px}
        .quote-text{font-size:17px;line-height:1.33}
        .related{padding:28px 0 44px}.related-grid{grid-template-columns:minmax(0,1fr)}
      }
    `}</style>
