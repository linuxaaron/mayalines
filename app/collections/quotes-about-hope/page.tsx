...
export default function HopeQuotesPage() {
  return (
    <main className="page">
      ...
      <div className="wrap">
        <header className="head"><Link href="/">← MAYALINES</Link><p className="eyebrow">CURATED COLLECTION</p><h1>Hope Quotes</h1><p className="intro">Timeless words about hope, perseverance, renewal and finding light in difficult moments.</p></header>
        ...
        <section className="related"><h2>Explore more</h2><Link href="/collections/quotes-about-life">Life Quotes</Link><Link href="/collections/quotes-about-courage">Courage Quotes</Link><Link href="/collections/short-inspirational-quotes">Short Inspirational Quotes</Link></section>
      </div>
    </main>
  );
}
