...
const quotes = [
  ...
  { text: "Fortune always favors the brave, and never helps a man who is his own enemy.", author: "Terence" },
  { text: "Courage is found in unlikely places.", author: "J. R. R. Tolkien" },
];

export default function CourageQuotesPage() {
  return (
    <main className="page">
      ...
      <div className="wrap">
        <header className="head"><Link href="/">← MAYALINES</Link><p className="eyebrow">CURATED COLLECTION</p><h1>Courage Quotes</h1><p className="intro">Timeless words about bravery, fear, resilience and finding the strength to act.</p></header>
