...
export default function ImprintPage() {
  return <main className="legal-page">
    ...
    <article id="content">
      ...
      <address><strong>Aaron</strong><br />Im Sinnighofen 8b<br />79189 Bad Krozingen<br />Germany</address>
      <h2>Contact</h2>
      <p>Email: <a href="mailto:joschaschmidt@mail.de">joschaschmidt@mail.de</a></p>
      <h2>Responsible for Content</h2>
      <address>Aaron<br />Im Sinnighofen 8b<br />79189 Bad Krozingen<br />Germany</address>
